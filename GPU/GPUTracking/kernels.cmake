...
o2_gpu_add_kernel("GPUTPCTrackletSelector, count"                         "= TPCTRACKER"                                          LB)
o2_gpu_add_kernel("GPUTPCTrackletSelector, offsets"                       "= TPCTRACKER")
o2_gpu_add_kernel("GPUTPCTrackletSelector, scatter"                       "= TPCTRACKER"                                          LB)
o2_gpu_add_kernel("GPUTPCTrackletSelector"                                "= TPCTRACKER"                                          LB)
o2_gpu_add_kernel("GPUTPCTrackletSelector, selectPacked"                  "= TPCTRACKER"                                          LB)
o2_gpu_add_kernel("GPUTPCTrackletPacking, count"                          "= TPCTRACKER"                                          LB)
o2_gpu_add_kernel("GPUTPCTrackletPacking, offsets"                        "= TPCTRACKER")
o2_gpu_add_kernel("GPUTPCTrackletPacking, scatter"                        "= TPCTRACKER"                                          LB)
o2_gpu_add_kernel("GPUTPCTrackletPacking, sweep"                          "= TPCTRACKER")
o2_gpu_add_kernel("GPUTPCTrackletPacking, gather"                         "= TPCTRACKER"                                          LB)
