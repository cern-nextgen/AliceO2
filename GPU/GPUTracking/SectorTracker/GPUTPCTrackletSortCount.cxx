...
/// \file GPUTPCTrackletSortCount.cxx
...
template <>
GPUdii() void GPUTPCTrackletSortCount::Thread<0>(int32_t nBlocks, int32_t nThreads, int32_t iBlock, int32_t iThread, GPUsharedref() GPUSharedMemory& s, processorType& GPUrestrict() tracker)
{
